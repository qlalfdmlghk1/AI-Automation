...
> - Jira/GitHub/Confluence처럼 미리보기가 유용한 링크는 **스마트 링크**로: `<a href="URL" data-card-appearance="inline">DEV-202</a>` (HTML 발행 시).
...
> - **발행 후 검증**: 반환된 페이지를 `getConfluencePage`(또는 웹 URL)로 열어 "관련 링크" 표의 Jira/GitHub/PR 링크가 실제 클릭 가능한지 확인합니다. 평문으로 굳었으면 `updateConfluencePage`로 앵커 형태로 교정합니다.
